...
class __TwigTemplate_f08c6c5a81a4559509cb6d3402f7cea0458088cbeb6e120bf706624ff15c207e extends Twig_Template
{
...
";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 13
                    echo "    <li><code>";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["item"], "dep", array()), "html", null, true);
                    echo "</code> (";
...
<input type=\"radio\" name=\"2fa_configure\" ";
                // line 49
                if (($this->getAttribute($context["backend"], "id", array(), "array") == "")) {
                    echo "checked=\"checked\"";
                }
                echo " value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($context["backend"], "id", array(), "array"), "html", null, true);
                echo "\"/>
<strong>";
                // line 50
                echo twig_escape_filter($this->env, $this->getAttribute($context["backend"], "name", array(), "array"), "html", null, true);
                echo "</strong>
<p>";
                // line 51
                echo twig_escape_filter($this->env, $this->getAttribute($context["backend"], "description", array(), "array"), "html", null, true);
                echo "</p>
</label>
";
            }
...
";
    ...
    {
        return new Twig_Source("", "prefs_twofactor.twig", "/Users/sdf/vm/ada/api/admin/templates/prefs_twofactor.twig");
    }
}
