...
class Coaches
{
    ...
    public function bookingsGet($request, $response, $args)
    {
      ...
      $data = array();
      $busCounts = array();
      $data = $this->mcCustom->select('TblCoachesBookings',
      ...
      foreach($data as &$booking)
      {
          ...
          $pupil = new \Entities\People\iSamsStudent($this->isams, $booking['txtSchoolID']);
    ...
    public function coachesGet($request, $response, $args)
    {
      try{
