...
class CovidHODS {
      ...
      $to = 'sdf@marlboroughcollege.org';
			...
			if (count($notAnsweredNames) > 0) {
				...
				$notAnsweredHTML = "<p style='margin-top:0; margin-bottom: 10px; color:#2F3133;font-size:16px;line-height:1.5em;text-align:left;font-weight:bold;' >Not Checked In</p>";
			...
			if (count($alertNames) > 0) {
				...
				$alertHTML = '';
				foreach($alertNames as $n) $alertHTML .= "<p style='margin-top:0;color:#2F3133;font-size:16px;line-height:1.5em;text-align:left;font-weight:normal;' >$n</p>";
			}

			if (count($notInWorkNames) > 0) {
				$notInWorkHTML = "<p style='margin-top:0; margin-bottom: 10px; color:#2F3133;font-size:16px;line-height:1.5em;text-align:left;font-weight:bold;' >Not In School Today</p>";
				foreach($notInWork as $n) $notInWorkHTML .= "<p style='margin-top:0;color:#2F3133;font-size:16px;line-height:1.5em;text-align:left;font-weight:normal;' >$n</p>";
			}
